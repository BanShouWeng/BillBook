package com.bsw.billbook.widget.timeselector;
...
import com.bsw.billbook.widget.timeselector.Utils.DateUtil;
import com.bsw.billbook.widget.timeselector.Utils.ScreenUtil;
import com.bsw.billbook.widget.timeselector.view.PickerView;
...
public class TimeSelector {
    ...
    public interface ResultHandler {
        void handle(String tag, String time);
    }
    ...
    public void show(String tag, String showTime) {
        ...
        showTimes.add(Integer.parseInt(showtimes[1]) - 1);
        showTimes.add(Integer.parseInt(showtimes[2]) - 1);
        showTimes.add(Integer.parseInt(showtimes[3]));
        showTimes.add(Integer.parseInt(showtimes[4]));
...
//        }
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                handler.handle(tag, DateUtil.format(selectedCalender.getTime(), FORMAT_STR));
                seletorDialog.dismiss();
            }
        });
    }
    ...
    private void loadComponent() {
        ...
        if (showTimes == null) {
            int defaultYear = year.size() - 1 < 0 ? 0 : (year.size() - 1);
            month_pv.setSelected(defaultYear);
            day_pv.setSelected(0);
            hour_pv.setSelected(0);
            minute_pv.setSelected(0);
            year_pv.setSelected(0);
        } else {
            year_pv.setSelected(showTimes.get(0));
            month_pv.setSelected(showTimes.get(1));
            day_pv.setSelected(showTimes.get(2));
            hour_pv.setSelected(showTimes.get(3));
            minute_pv.setSelected(showTimes.get(4));
        }
        excuteScroll();
//        initCalender();
    }
    ...
    private void initCalender() {
        selectedCalender.set(Calendar.MONTH, showTimes.get(0));
        selectedCalender.set(Calendar.DAY_OF_MONTH, showTimes.get(1) + 1);
        selectedCalender.set(Calendar.HOUR_OF_DAY, showTimes.get(2));
        selectedCalender.set(Calendar.MINUTE, showTimes.get(3));
    }
