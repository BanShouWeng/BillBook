...
public class OutgoingActivity extends BaseLayoutActivity {
    ...
    protected void formatData() {
        ...
        if (Const.notEmpty(itemBean)) {
            ...
            infoNumberPlateInput.setText(itemBean.getNumberPlate());
            infoSignInput.setText(TxtUtils.getText(itemBean.getSign()));
            infoRepairInput.setText(TxtUtils.getText(itemBean.getRepair()));
        }
    }
    ...
    private void setEnable(boolean enable) {
        ...
        infoNumberPlateInput.setEnabled(enable);
        infoSignInput.setEnabled(enable);
        infoRepairInput.setEnabled(enable);
    }
                            ...
                            public void execute(@NonNull Realm realm) {
                                try {
                                    itemBean.setOperatingTime(DateFormatUtils.parse(operatingTime, DateFormatUtils.COMMON_FORMAT))
                                            .setType(RecordItemBean.TYPE_OUTGOING)
